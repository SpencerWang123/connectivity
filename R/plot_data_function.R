...
#' @export
#'
plot_data_function=function(temp_seq,temp_connect_record,temp_community_df)
{
  #下面按照真实颜色画图！
  ...
  col_available=cbind(sample(1:community_num,community_num),rainbow(community_num));colnames(col_available)=c("community","color")
